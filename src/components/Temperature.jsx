  ...
  return (
    <>
      <div className="flex align-middle justify-center">
        <input
          type="text"
          className="bg-slate-500 border border-slate-400 text-slate-200 placeholder-slate-400 text-md focus:border-slate-400 block w-60 p-2 focus:outline-none"
      ...
      <div className="flex justify-center mt-5 text-[15px] text-white">
